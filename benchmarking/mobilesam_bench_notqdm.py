...
def main(args):
    ...
    # set compiling device
    device = torch.device(args.device)

    # load & prep model
    sam = sam_model_registry[args.model_type](checkpoint=args.model_path)  # model type typically: 'vit_t', 'vit_l'
    ...
    print(f"✅ Mobile SAM benchmark complete - results saved to {full_path}")
